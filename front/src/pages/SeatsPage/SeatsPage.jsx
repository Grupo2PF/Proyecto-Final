    ...
    const handleCheck = (e) => {
        ...
        if (checked && input.length < allSeatsLimit) {
            ...
            if (input.length === pax.length - 1)
                return alert(
                    `asiento ${e.target.value} seleccionado exitosamente! Recuerda, se tomaran como validos unicamente ${pax.length} asiento por vuelo`
                );
        ...
        return (
            <div className={styles.allSeats}>
                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.allFlightSeats}>{allFlightSeats}</div>
